...
<head>
    ...
    <script type="text/javascript">
        ...
        //实现动态增加一行
        function addTRRecord(objId, exportProductId, productNo, cnumber, grossWeight, netWeight, sizeLength, sizeWidth, sizeHeight, exPrice, tax) {
            ...
            oTD.innerHTML = "<input class=\"input\" type=\"checkbox\" name=\"del\" value=\"" + exportProductId + "\"><input type=\"hidden\" name=\"mr_exportProductId\" value=\"" + exportProductId + "\"><input class=\"input\" type=\"hidden\" id=\"mr_changed\" name=\"mr_changed\">";
            ...
            oTD.innerHTML = "<input type=\"text\" name=\"mr_tax\" maxLength=\"10\" value=\"" + 0 + "\" onBlur=\"setTRUpdateFlag(this);\" size=\"15\">";
        ...
        // //鼠标抬起时为该行添加更改标记
        // $("input [name = 'del']").onclick(function () {
        //     console.log(this);
        ...
        //
        // function qinjiahao() {
        //     var del = $("input [name = 'del']").attr("checked");
        //     let $input = $("input [name='mr_orderNo']");
        //     console.log(del);
        //     if (del) {
        //         $input.value = "1";
    ...
    <div id="menubar">
        <div id="middleMenubar">
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        <li id="save"><a href="#" onclick="formSubmit('${ctx}/exp/updateExp','_self');">确定</a></li>
                        <li id="back"><a href="${ctx}/exp/findExp">返回</a></li>
                    </ul>
                </div>
            </div>
        </div>
