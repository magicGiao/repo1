...
<ul>
<li id="save">
	<a href="#" onclick="formSubmit('${pageContext.request.contextPath}/fac/addFac','_self');">确定</a>
</li>
<li id="back"><a href="${pageContext.request.contextPath}/fac/findFacAll">返回</a></li>
</ul>
    </div>
</div>
</div>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
				...
				<input type="hidden" name="createDept" value="1">
				</td>
