            ...
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        ...
                        <li id="save"><a href="#" onclick="formSubmit('${ctx}/pro/addPro','_self');">确定</a></li>
            ...
            <div>
                <table class="commonTable" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="tableContent"><input type="text" name="packingUnit"/>PCS/SETS</td>
                    </tr>
                    <tr>
                    ...
                    <table id="ec_table" class="tableRegion" width="98%">
                        ...
                        <c:forEach items="${dataList}" var="o" varStatus="status">
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
                                <td><input type="checkbox" name="contractProductId" value="${o.contractProductId}"/>
                                </td>
                                ...
                                <td>${o.amount}</td>
                                <td>
                                    <a href="${ctx}/pro/deletePro?contractProductId=${o.contractProductId}&contractId=${contractId}">
                                        删除</a>
                                    <a href="${ctx}/pro/updateProTo?contractProductId=${o.contractProductId}&contractId=${contractId}">
                                        修改</a></td>
                                <td>
                                    <a href="${ctx}/ect/findExtAll?contractProductId=${o.contractProductId}&contractId=${contractId}">
                                        附件</a></td>
                            </tr>
                        </c:forEach>
