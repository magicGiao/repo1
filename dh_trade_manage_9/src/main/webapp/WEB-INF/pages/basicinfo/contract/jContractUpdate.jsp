...
<%--						<li id="save"><a href="#" onclick="formSubmit('${ctx}/con/updateCon');">确定</a></li>--%>
<%--						<li id="save"><a href="#" onclick="formSubmit('${ctx}/con/findConAll');">确定</a></li>--%>
...
<%--					<input type="text" style="width:90px;" name=""  value="${obj.signingDate}" />--%>
				</td>
	        ...
	        <tr>
	            ...
	            <td class="tableContent">
<%--					<input type="text" style="width:90px;" name="deliveryPeriod"  value="${obj.deliveryPeriod}" />--%>
	            ...
	            <td class="tableContent">
<%--					<input type="text" style="width:90px;" name=""  value="${obj.shipTime}" />--%>
