    ...
    <div id="menubar">
        <div id="middleMenubar">
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        <li id="save"><a href="#" onclick="formSubmit('${ctx}/ect/addExt','_self');">确定<input
                                type="hidden" value="${contractId}" name="contractId"></a></li>
                        <li id="back"><a href="${ctx}/pro/addProTo?contractId=${contractId}">返回</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <table id="ec_table" class="tableRegion" width="98%">
                        ...
                        <c:forEach items="${dataList}" var="o" varStatus="status">
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
                                ...
                                <td>${o.amount}</td>
                                <td>
                                    <a href="${ctx}/ect/findExtOne?extCproductId=${o.extCproductId}&contractId=${contractId}">[修改]</a>
                                    <a href="${ctx}/ect/deleteExt?extCproductId=${o.extCproductId}&contractProductId=${o.contractProductId}&contractId=${contractId}">[删除]</a>
                                </td>
                            </tr>
                        </c:forEach>
