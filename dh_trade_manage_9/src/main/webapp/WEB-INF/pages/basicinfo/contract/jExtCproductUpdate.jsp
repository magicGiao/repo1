...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${ctx}/ect/updateExt','_self');">确定</a></li>
<li id="back"><a href="${ctx}/ect/findExtAll?contractProductId=${obj.contractProductId}&contractId=${contractId}">返回</a></li>
</ul>
    </div>
</div>
</div>
